...
### --sourceout    default='rtmp://218.192.100.219/live/livestream1'   输出流 
### --sourcecheck   default='http://218.192.100.219:1985/api/v1/streams/'   检查地址


## detectground.py  地面模型   
### --source   default='rtmp://218.192.100.219/live/livestream3'    输入流 
### --sourceout    default='rtmp://218.192.100.219/live/livestream2'   输出流 
### --sourcecheck   default='http://218.192.100.219:1985/api/v1/streams/'   检查地址

## kill 命令 （只有一个python进程的情况下）
### pgrep python | xargs kill -s 15
